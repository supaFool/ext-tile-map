...
{
    /// <summary>
    /// An Interface for pseudo-random number generators to implement. Useful when mocking out
    /// systems for tests, as the the random number generator can be swapped for a mock
    /// implementation that returns known and expected values
    /// </summary>
    /// <remarks>
    /// Pseudo-random number generators are devices that produces a sequence of numbers that meet
    ...
    /// <summary>
    /// A class representing the state of a pseudo-random number generation algorithm at a point in
    /// time. This POCO (Plain Old C# Object) can be easily serialized and deserialized
    /// </summary>
    public class RandomState
    {
        /// <summary>
        /// The number of times that the Next method has been called on the pseudo-random number
        ...
        /// </summary>
        /// <remarks>
        /// Most generators only use 1 seed, but some like the KnownSeriesRandom generator may use
        /// multiple seeds so that is why Seed is expressed as an array of integers here
        /// </remarks>
