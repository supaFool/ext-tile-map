...
{
    /// <summary>
    /// A Map represents a rectangular grid of Cells, each of which has a number of properties for
    /// determining walkability, field-of-view and so on The upper left corner of the Map is Cell
    /// (0,0) and the X value increases to the right, as the Y value increases downward
    /// </summary>
    public interface IMap
    {
        ...
        /// </summary>
        /// <remarks>
        /// A Map with a Height of 20 will have Cells with Y locations of 0 through 19 Cells with an
        /// Y value of 0 will be the topmost Cells
        /// </remarks>
        int Height
        {
            get;
        ...
        /// </summary>
        /// <remarks>
        /// A Map with a Width of 10 will have Cells with X locations of 0 through 9 Cells with an X
        /// value of 0 will be the leftmost Cells
        /// </remarks>
        int Width
        {
            get;
        ...
        /// <summary>
        /// Performs a field-of-view calculation with the specified parameters and appends it any
        /// existing field-of-view calculations. Field-of-view (FOV) is basically a calculation of
        /// what is observable in the Map from a given Cell with a given light radius.
        /// </summary>
        /// <example>
        /// When a character is holding a light source in a large area that also has several other
        /// sources of light such as torches along the walls ComputeFov could first be called for
        /// the character and then AppendFov could be called for each torch to give us the final
        /// combined FOV given all the light sources
        /// </example>
        /// <param name="xOrigin">
        ...
        /// </param>
        /// <param name="radius">
        /// The number of Cells in which the field-of-view extends from the origin Cell. Think of
        /// this as the intensity of the light source.
        /// </param>
        /// <param name="lightWalls">
        /// True if walls should be included in the field-of-view when they are within the radius of
        /// the light source. False excludes walls even when they are within range.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Get the Cell at the specified single dimensional array index using the formulas: x =
        /// index % Width; y = index / Width;
        /// </summary>
        /// <param name="index">
        ...
        /// Optional parameter defaults to false if not provided. True if line-of-sight is not
        /// blocked by this Cell. False otherwise
        /// </param>
        /// <param name="isWalkable">
        /// Optional parameter defaults to false if not provided. True if a character could walk
        /// across the Cell normally. False otherwise
        /// </param>
        ...
        /// <summary>
        /// Performs a field-of-view calculation with the specified parameters. Field-of-view (FOV)
        /// is basically a calculation of what is observable in the Map from a given Cell with a
        /// given light radius. Any existing field-of-view calculations will be overwritten when
        /// calling this method.
        /// </summary>
        /// <param name="xOrigin">
        /// X location of the Cell to perform the field-of-view calculation with 0 as the farthest left
        ...
        /// An IMap which must be of smaller size and able to fit in this destination Map at the
        /// specified location
        /// </param>
        void Copy(IMap sourceMap);

        /// <summary>
        /// Copies the Cell properties of a smaller source Map into this destination Map at the
        /// specified location
        /// </summary>
        /// <param name="sourceMap">
        /// An IMap which must be of smaller size and able to fit in this destination Map at the
        ...
        /// </param>
        /// <param name="left">
        /// Optional parameter defaults to 0 if not provided. X location of the Cell to start
        /// copying parameters to, starting with 0 as the farthest left
        /// </param>
        /// <param name="top">
        /// Optional parameter defaults to 0 if not provided. Y location of the Cell to start
        /// copying parameters to, starting with 0 as the top
        /// </param>
        ...
        /// <summary>
        /// Get an IEnumerable of outermost border Cells in a circle around the center Cell up to
        /// the specified radius using Bresenham's midpoint circle algorithm
        /// </summary>
        /// <seealso href="https://en.wikipedia.org/wiki/Midpoint_circle_algorithm">
        ...
        /// <summary>
        /// Get an IEnumerable of outermost border Cells in a diamond (Rhombus) shape around the
        /// center Cell up to the specified distance
        /// </summary>
        /// <param name="xCenter">X location of the center Cell with 0 as the farthest left</param>
        /// <param name="yCenter">Y location of the center Cell with 0 as the top</param>
        ...
        /// <summary>
        /// Get an IEnumerable of outermost border Cells in a square area around the center Cell up
        ...
        /// <summary>
        /// Get an IEnumerable of Cells in a line from the Origin Cell to the Destination Cell The
        /// resulting IEnumerable includes the Origin and Destination Cells Uses Bresenham's line
        /// algorithm to determine which Cells are in the closest approximation to a straight line
        ...
        /// </param>
        /// <param name="xDestination">
        /// X location of the Destination Cell at the end of the line with 0 as the farthest left
        /// </param>
        /// <param name="yDestination">
        /// Y location of the Destination Cell at the end of the line with 0 as the top
        /// </param>
        /// <returns>
        /// IEnumerable of Cells in a line from the Origin Cell to the Destination Cell which
        /// includes the Origin and Destination Cells
        /// </returns>
        IEnumerable<ICell> GetCellsAlongLine(int xOrigin, int yOrigin, int xDestination, int yDestination);

        /// <summary>
        /// Get an IEnumerable of Cells in a circle around the center Cell up to the specified
        /// radius using Bresenham's midpoint circle algorithm
        /// </summary>
        /// <seealso href="https://en.wikipedia.org/wiki/Midpoint_circle_algorithm">
        /// Based on Bresenham's midpoint circle algorithm
        /// </seealso>
        ...
        /// <summary>
        /// Get an IEnumerable of Cells in a diamond (Rhombus) shape around the center Cell up to
        ...
        /// <summary>
        /// Get the single dimensional array index for a Cell at the specified location using the
        ...
        /// <returns>
        /// An index for the Cell at the specified location useful if storing Cells in a single
        /// dimensional array
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This is basically a solid stone map that would then need to be modified to have
        ...
        /// </summary>
        /// <remarks>
        /// The explored property of a Cell can be used to track if the Cell has ever been in the
        /// field-of-view of a character controlled by the player This property will not
        /// automatically be updated based on FOV calculations or any other built-in functions of
        /// the RogueSharp library.
        /// </remarks>
        /// <example>
        /// As the player moves characters around a Map, Cells will enter and exit the currently
        /// computed field-of-view This property can be used to keep track of those Cells that have
        /// been "seen" and could be used to show fog-of-war type effects when rendering the map
        /// </example>
        ...
        /// <summary>
        /// Check if the Cell is in the currently computed field-of-view For newly initialized maps
        /// a field-of-view will not exist so all Cells will return false Field-of-view must first
        /// be calculated by calling ComputeFov and/or AppendFov
        /// </summary>
        /// <remarks>
        /// Field-of-view (FOV) is basically a calculation of what is observable in the Map from a
        /// given Cell with a given light radius
        /// </remarks>
        /// <example>
        /// Field-of-view c be used to simulate a character holding a light source and exploring a
        /// Map representing a dark cavern Any Cells within the FOV would be what the character
        /// could see from their current location and lighting conditions
        /// </example>
        /// <param name="x">X location of the Cell to check starting with 0 as the farthest left</param>
        /// <param name="y">Y location of the Cell to check, starting with 0 as the top</param>
        ...
        /// </summary>
        /// <example>
        /// A Cell representing an empty stone floor would be transparent A Cell representing a
        /// glass wall could be transparent (even though it may not be walkable) A Cell representing
        /// a solid stone wall would not be transparent
        /// </example>
        /// <param name="x">X location of the Cell to check starting with 0 as the farthest left</param>
        /// <param name="y">Y location of the Cell to check, starting with 0 as the top</param>
        ...
        /// <summary>
        /// Get the walkability of the Cell i.e. if a character could normally move across the Cell
        /// without difficulty
        /// </summary>
        /// <example>
        /// A Cell representing an empty stone floor would be walkable A Cell representing a glass
        /// wall may not be walkable (even though it could be transparent) A Cell representing a
        /// solid stone wall would not be walkable
        /// </example>
        /// <param name="x">X location of the Cell to check starting with 0 as the farthest left</param>
        /// <param name="y">Y location of the Cell to check, starting with 0 as the top</param>
        ...
        /// </summary>
        /// <param name="state">
        /// MapState POCO (Plain Old C# Object) which represents this Map and can be easily
        /// serialized and deserialized
        /// </param>
        void Restore(MapState state);

        /// <summary>
        /// Get a MapState POCO which represents this Map and can be easily serialized Use Restore
        /// with the MapState to get back a full Map
        /// </summary>
        /// <returns>
        ...
        /// </summary>
        /// <remarks>
        /// IsInFov cannot be set through this method as it is always calculated by calling
        /// ComputeFov and/or AppendFov
        /// </remarks>
        /// <param name="x">
        ...
        /// </param>
        /// <param name="isExplored">
        /// Optional parameter defaults to false if not provided. True if the Cell has ever been in
        /// the field-of-view of the player. False otherwise
        /// </param>
        ...
        /// </summary>
        /// <param name="useFov">
        /// True if field-of-view calculations will be used when creating the string representation
    ...
    /// <summary>
    /// A class representing the state of a Map which can be used to Restore a Map to a previously
    /// Saved state This POCO (Plain Old C# Object) can be easily serialized and deserialized
    /// </summary>
    public class MapState
    {
        ...
        /// <summary>
        /// An array of the Flags Enumeration of CellProperties for each Cell in the Map. The index
        /// of the array corresponds to the location of the Cell within the Map using the formula:
        /// index = ( y * Width ) + x
        /// </summary>
