...
namespace RogueSharp.Algorithms
{
    ...
    /// </summary>
    /// <seealso href="http://algs4.cs.princeton.edu/41undirected/DepthFirstPaths.java.html">
    /// DepthFirstPaths class from Princeton University's Java Algorithms
    /// </seealso>
    public class DepthFirstPaths
    {
        ...
        /// <returns>
        /// True if there is a path between the sourceVertex and the specified destinationVertex,
        /// false otherwise
        /// </returns>
        ...
        /// <summary>
        /// Returns a path between the sourceVertex and the specified destinationVertex or null if
        /// no such path exists
        /// </summary>
        /// <param name="destinationVertex">The destination vertex</param>
        /// <returns>
        /// An IEnumerable sequence of vertices representing the path between the sourceVertex and
        /// the specified destinationVertex or null if no such path exists. The path will not
