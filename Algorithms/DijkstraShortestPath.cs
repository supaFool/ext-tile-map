...
{
    /// <summary>
    /// The DijkstraShortestPath class represents a data type for solving the single-source shortest
    /// paths problem in edge-weighted digraphs where the edge weights are non-negative
    /// </summary>
    /// <seealso href="http://algs4.cs.princeton.edu/44sp/DijkstraSP.java.html">
    ...
    public class DijkstraShortestPath
    {
        ...
        /// <summary>
        /// Computes a shortest paths tree from the specified sourceVertex to every other vertex in
        /// the edge-weighted directed graph
        /// </summary>
        ...
        /// Throws an ArgumentOutOfRangeException if an edge weight is negative
        /// </exception>
        ...
        private DijkstraShortestPath(EdgeWeightedDigraph graph, int sourceVertex, int? destinationVertex)
        {
            ...
            // TODO: Consider optimizations for building in Release vs Debug
        ...
        /// <summary>
        /// Returns an IEnumerable of DirectedEdges representing a shortest path from the specified
        /// sourceVertex to the specified destinationVertex This is more efficient than creating a
        /// new DijkstraShortestPath instance and calling PathTo( destinationVertex ) when we only
        /// want a single path from Source to Destination and don't want many paths from the source
        ...
        /// <returns>
        /// IEnumerable of DirectedEdges representing a shortest path from the sourceVertex to the
        /// specified destinationVertex
        /// </returns>
        ...
        /// <param name="destinationVertex">The destination vertex to find a shortest path to</param>
        /// <returns>
        /// The length of a shortest path from the sourceVertex to the specified destinationVertex
        /// or double.PositiveInfinity if no such path exists
        /// </returns>
        ...
        /// <returns>
        /// True if there is a path from the sourceVertex to the specified destinationVertex, false otherwise
        /// </returns>
        ...
        /// <summary>
        /// Returns an IEnumerable of DirectedEdges representing a shortest path from the
        /// sourceVertex to the specified destinationVertex
        /// </summary>
        /// <param name="destinationVertex">The destination vertex to find a shortest path to</param>
        /// <returns>
        /// IEnumerable of DirectedEdges representing a shortest path from the sourceVertex to the
