...
{
    /// <summary>
    /// The CaveMapCreationStrategy creates a Map of the specified type by using a cellular automata
    /// algorithm for creating a cave-like map.
    /// </summary>
    /// <seealso href="http://www.roguebasin.com/index.php?title=Cellular_Automata_Method_for_Generating_Random_Cave-Like_Levels">
    ...
    public class CaveMapCreationStrategy<T> : IMapCreationStrategy<T> where T : class, IMap, new()
    {
        ...
        /// Recommend int between 40 and 60. Percent chance that a given cell will be a floor when
        ...
        /// </param>
        /// <param name="cutoffOfBigAreaFill">
        /// Recommend int less than 4. The iteration number to switch from the large area fill
        /// algorithm to a nearest neighbor algorithm
        /// </param>
        /// <param name="random">
        /// A class implementing IRandom that will be used to generate pseudo-random numbers
        /// necessary to create the Map
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// The map will be generated using cellular automata. First each cell in the map will be
        /// set to a floor or wall randomly based on the specified fillProbability. Next each cell
        /// will be examined a number of times, and in each iteration it may be turned into a wall
        /// if there are enough other walls near it. Once finished iterating and examining
        /// neighboring cells, any isolated map regions will be connected with paths.
        /// </remarks>
