...
{
    /// <summary>
    /// A class for performing field-of-view calculations to determine what is observable in a Map
    /// from a given Cell within a given light radius
    /// </summary>
    /// <seealso href="https://sites.google.com/site/jicenospam/visibilitydetermination">
    ...
    public class FieldOfView
    {
        ...
        public ReadOnlyCollection<ICell> AppendFov(int xOrigin, int yOrigin, int radius, bool lightWalls)
        {
            ...
            if (lightWalls)
            {
                // Post processing step created based on the algorithm at this website: https://sites.google.com/site/jicenospam/visibilitydetermination
        ...
        /// <summary>
        /// Check if the Cell is in the currently computed field-of-view Field-of-view must first be
        /// calculated by calling ComputeFov and/or AppendFov
        /// </summary>
        /// <remarks>
