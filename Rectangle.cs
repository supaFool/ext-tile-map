...
namespace RogueSharp
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// <summary>
        /// Returns a value that indicates whether the Rectangle is empty true if the Rectangle is
        ...
        /// <summary>
        /// Specifies the x-coordinate of the Rectangle with 0 being to the left and increasing as
        /// the Rectangle is moved to the right
        /// </summary>
        public int X { get; set; }

        /// <summary>
        /// Specifies the y-coordinate of the Rectangle with 0 being at the top and increasing as
        /// the Rectangle is moved downwards
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="Rectangle"/> struct, with the specified position,
        /// width, and height.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="Rectangle"/> struct, with the specified location
        /// and size.
        /// </summary>
        /// <param name="location">
        /// The x and y coordinates of the top-left corner of the created <see cref="Rectangle"/>.
        /// </param>
        ...
        /// <returns>
        /// The area where the two specified Rectangles overlap. If the two Rectangles do not
        /// overlap the resulting Rectangle will be Empty
        /// </returns>
        ...
        /// inserting this Rectangle into a hash-based collection such as a Dictionary or Hashtable
        /// </summary>
