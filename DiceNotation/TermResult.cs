namespace RogueSharp.DiceNotation
{
    ...
    public class TermResult
    {
        ...
        /// <summary>
        /// A string representing the type of this Term. Possible values are "constant" or
        /// "d(sides)" In 1d6 + 5, the 1d6 term is of type "d6" and the 5 term is of type "constant"
        /// </summary>
